...
<body>
    ...
    <fieldset>
        ...
        <li><input type="radio" name="currency" value="0.0047"<?php if(isset($_POST['currency']) && $_POST['currency'] == 0.0047) {echo 'checked="checked"';} ?>> Yen </li>
        </ul>
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $_POST['bank'])) {
        ...
        if ($dollars < 1000) { 
             echo '<div class="box2"><h2>I am NOT happy, because I have $'.number_format($dollars, 2).' American dollars! </h2><br>
             <iframe width="560" height="315" src="https://www.youtube.com/embed/l5aZJBLAu1E?si=QAXfeLwTgEQ3qhHK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>';

        } else {
            echo '<div class="box2"><h2>I am REALLY happy, because I have $'.number_format($dollars, 2).' American dollars! </h2><br>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/O5APc0z49wg?si=GRgHAhhVVSZ1C6F8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>';
