...
echo '<b>This is my volume:</b> '.$my_array[1].'';
...
echo '<b>This is my volume:</b> '.$volume.'';
...
echo '<h2>The logic behind the wines on our form</h2><p>If post wines is not empty, take post wines and implode them, and create a new variables named $my_wines</p>
